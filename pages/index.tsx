      ...
      <main className='bg-white px-10 md:px-20 lg:px-40'>
        <section className='min-h-screen'>
          ...
          <div className='text-center p-10 py-1'>
            ...
            <p className='text-med py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto'>Skilled data professional offering data-driven solutions to unlock the potential of your data.
            </p>
          </div>
